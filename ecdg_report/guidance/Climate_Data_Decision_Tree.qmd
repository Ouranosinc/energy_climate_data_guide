...
Use the decision tree to identify a suitable category of data for the decision context. Then use [Compare Documented Datasets](../datasets/Datasets_Overview_Table.qmd) to compare products described in this guide, [Find Datasets by Variable](../datasets/Datasets_by_Variable.qmd) to locate products containing a required variable, and the individual dataset profiles for detailed strengths, limitations and expert guidance.
