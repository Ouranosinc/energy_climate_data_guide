...
Use the matrix to identify areas for organizational improvement, then consult [Organizational Gaps and Barriers](../gaps/gaps_organization.qmd) for common challenges affecting climate-data use. Where external expertise is needed, [Procuring Physical Climate-Risk Assessments](../guidance/Guidance_Harrington.qmd) provides questions to support informed procurement and oversight.
