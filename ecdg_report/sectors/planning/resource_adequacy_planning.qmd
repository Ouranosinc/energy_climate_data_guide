...
## Models
RAPs typically rely on probabilistic simulation models that evaluate system performance under uncertainty. These models simulate many realizations of demand, generator availability, and weather-dependent resources to assess whether a given resource portfolio can reliably meet electricity demand. A key feature of adequacy models is their chronological and weather-driven structure. Demand, renewable generation, and hydrologic conditions are represneted using historical or climate-projected weather datasets, allowing the models to capture variability, extreme events, and correlated risks. This makes climate data a critical input, directly shaping both load conditions and resource availability within adequacy assessments.
