...
Among the generation types, hydropower exhibits the strongest dependence on climate forcing, not only the amount of rainfall and temperature, but also snowpack accumulation and the timing and magnitude of freshet throughout the cold season. Academic studies have shown that warming trends shift snowmelt earlier in the year, increase winter inflows, and decrease summer water availability. The projected flows are subsequently used to estimate hydropower potential through empirical formulations (@Parkinson2015), reservoir optimization frameworks (@Haguma2014), or network-based allocation models (@kim_climate_2022). Despite the capability of these methods, many utilities continue to rely on long historical hydrologic sequences for planning.
