...
The figure below briefly resumes decision-making challenges faced by professionnals in the demand sector of the electricity system in Canada. These challenges were shared during the [workshops](../../workshops/intro_workshops.ipynb) held in 2025. These exemples linked together the methods and models as well as characteristics presented in the following section such as [ key climate inputs](#key-climate-inputs).

<iframe width="768" height="640" data-external="1" src="https://miro.com/app/live-embed/uXjVINO7YDw=/?focusWidget=3458764634253545086&embedMode=view_only_without_ui&embedId=974916117429&autoplay=true" frameborder="0" scrolling="no" allowfullscreen></iframe>
...
- **Irradiance**: Historical irradiance is also used to estimate demand forecasting, however in practice this variable is often produced by consultinf firm. 
...
:::{#id1 .callout collapse="true"}
### Temporal Resolution
- **Hourly**: captures short-term load dynamics and peak shifts. In pratice, hourly seemed to be the most common temporal resolution. 
- **Daily/Seasonal**: reflects climate sensitivity of intraday and seasonal load profiles
- **Annual/Decadal**: used in long-term planning documents 
...
![Figure 2. Typical patterns of temperature responses](image/Fig2_Typical_Patterns_of_Temperature_Responses.png)
...
:::{#id1 .callout collapse="true"} 
### Additional Information
- [Climate Datasets](../../datasets/Climate_Datasets_Overview.html)
