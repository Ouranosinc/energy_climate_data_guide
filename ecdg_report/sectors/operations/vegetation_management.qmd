...
Many [attributions](https://www.canada.ca/en/environment-climate-change/services/climate-change/science-research-data/extreme-weather-event-attribution.html) studies show that climate change has made recent wildfires more likely, with Canadian wildfire events in [2023](https://www.worldweatherattribution.org/climate-change-more-than-doubled-the-likelihood-of-extreme-fire-weather-conditions-in-eastern-canada/) being two times more likely to occur. Many factors influence forest fires as shown in the figure below: 1) climate conditions that are hot, dry and windy all of which may be more extreme and frequent due to climate change; 2) ignitions including human activity or lightning; 3) and vegetation which as discussed above may be more susceptible to fire due to climate changes like temperature increases. It is important to note that electricity assets can also be the source of ignition.  In California, 10% of wildfires are ignited by powerlines due to component failures, downed lines or conductor slaps. Distribution lines are also more at risk than transmission lines when it comes to igniting fires ((@Vahedi2025)).

[![Fire regime triangle taken from Climatedata.ca](https://climatedata.ca/assets/uploads/2024/10/Climate-Fire-Triangle_EN-1-1024x859-1.png "Fire regime triangle taken from Climatedata.ca"){fig-alt="Climate Fire Triangle" width=350}](https://climatedata.ca/resource/understanding-fire-weather-and-climate-change-basics/ "Understanding Fire Weather and Climate Change Basics")
...
[![Wildfire and Power System Interaction taken from @Vahedi2025 (p.10)](image/powergrid_fores_fires.png "Wildfire and Power system Interaction taken from @Vahedi2025 (p.10)"){fig-alt="Wildfire and Power System Interaction" width=900}](https://www.osti.gov/servlets/purl/2565134 "Wildfire and power grid nexus in a changing climate")
...
:::{#id1 .callout collapse="true"}
### Spatial Resolution
FWI is usually calculated at local stations (finer resolution), but can also be computed from [reanalysis](../../datasets/reanalysis_data/Reanalysis_Datasets.ipynb) or [climate projections](../../datasets/climate_projection_data/Climate_Projection_Datasets.qmd). ECCC application of projected FWI has a 50 km resolution. 
