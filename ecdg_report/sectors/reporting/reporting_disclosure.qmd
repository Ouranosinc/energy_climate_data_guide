...
## Methods and Models
Methods and models are not used directly in this process. Metrics, targets and reporting are often a consolidation of information from other processes such as [dam safety reviews](sectors/infrastructure/dam_safety_review.ipynb), [nuclear safety review](sectors/infrastructure/nuclear_safety_review.ipynb), [capacity expansion modelling](sectors/planning/capacity_expansion_modelling.ipynb), [generation forecasting](sectors/planning/generation_forecasting.ipynb), and other types of [infrastructure assessments](sectors/infrastructure/infrastructure_condition_assessment_and_investment_prioritization.ipynb).
